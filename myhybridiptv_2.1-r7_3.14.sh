...
echo -e "${CYAN}"
echo "################################################################"
echo "#   Start downloading and installing myhybridiptv_2.1-r7       #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/107/refs/heads/main/enigma2-plugin-extensions-myhybridiptv_2.1-r7_cortexa15hf-neon-vfpv4_py3.14.ipk"
IPK_NAME="enigma2-plugin-extensions-myhybridiptv_2.1-r7_cortexa15hf-neon-vfpv4_py3.14.ipk"

...
echo -e "${CYAN}"
echo "################################################################"
echo "#   Start downloading and installing hybridiptveditor_v1.01    #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/107/refs/heads/main/enigma2-plugin-extensions-hybridiptveditor_v1.01_all.ipk"
IPK_NAME="enigma2-plugin-extensions-hybridiptveditor_v1.01_all.ipk"

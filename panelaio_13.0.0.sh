...
echo -e "${CYAN}"
echo "################################################################"
echo "#       Start downloading and installing panelaio_13.0.0       #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/107/refs/heads/main/enigma2-plugin-extensions-panelaio_13.0.0_all.ipk"
IPK_NAME="enigma2-plugin-extensions-panelaio_13.0.0_all.ipk"
